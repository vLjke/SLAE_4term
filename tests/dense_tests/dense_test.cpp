...
// matrix 10x10 get 10 elements test
TEST(Dense_matrix_tests, matrix_get_elem) {
    std::string filename("/home/vljke/Documents/Clion projects/SLAE_4term/tests/dense_tests/Dense_matrix_get_elem.txt");
    std::string temp, s;
    std::ifstream file(filename);
    if (file.is_open()) {
        // Getting matrix dimensions
